...
#echo "Checking VPS"
#Bytes=$(curl https://raw.githubusercontent.com/Matthewvpn-creator/vpn-server-installer/main/ipvps | grep $MYIP | awk '{print $3}')
#if [ $MYIP = $MYIP ]; then
...
Documentation=https://t.me/artixPH2024
...
echo " "
echo "=================================-ARTIXPH SCRIPTS-===========================" | tee -a log-install.txt
